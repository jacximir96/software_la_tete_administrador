...
<head>
    ...
    <title>Salidas de Productos de Limpieza</title>
    {{-- BOOTSTRAP 4 --}}
...
<body>
    <table class="table table-sm borderless" id="tabla_titulo">
        ...
        <thead>
        <tr>
                <th colspan="4" style="text-align:center;font-size:0.8rem">Salidas de Productos de Limpieza del Mes de 
                    @if($mfecha == 1)
                        ENERO
                    @elseif($mfecha == 2)
                        FEBRERO
    ...
    <table class="table table-bordered table-sm" id="tabla_cronogramaGeneral" style="text-align:center;">
        ...
        <tbody>
            <tr>
                ...
                <td>{{$valor_kardexLimpiezaTotal->nombres_empleado}} {{$valor_kardexLimpiezaTotal->apellidos_empleado}}</td>
